...
public class LevelManager : Singleton<LevelManager>
{
    ...
    private void SpawnLevel(int levelCount)
    {
        ...
        uiManager.goal = goalForLevel;
        uiManager.UpdateGoalText();
        BallManager.I.SpawnBalls(levels[levelCount-1].ballCountToSpawn,currentLevelprefab.transform,ballSpawnPos);
        var touchController = TouchController.I;
        touchController.lerpedRotateAmount = 0;
        touchController.objectToRotate = currentLevelprefab.transform;
